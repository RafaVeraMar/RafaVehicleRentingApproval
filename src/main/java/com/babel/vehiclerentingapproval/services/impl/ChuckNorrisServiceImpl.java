...
public class ChuckNorrisServiceImpl implements ChuckNorrisService {
    ...
    public String getRandomJoke() {
        String objectJoke = new RestTemplate().getForObject("https://api.chucknorris.io/jokes/random", String.class);
    ...
    public JokeCategories getJokeCategoryList() {
        String jokeCategories= new RestTemplate().getForObject("https://api.chucknorris.io/jokes/categories", String.class);
